...
exports.getLeaderBoard = ( async (req, res) => {
    ...
    try {
        const data = await db('user_event_participation')
                            .innerJoin('users','users.user_id','=','user_event_participation.user_id')
                            ...
                            .returning('user_event_participation.user_id','users.name','user_event_participation.start_time','user_event_participation.end_time');
